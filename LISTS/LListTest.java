...
public class LListTest extends TestCase {
  ...
  public void testRemoveLast() {
    ...
    assertEquals("added two items and first was Shampoo", "Shampoo", l.get(0));
    assertEquals("added two items and second was Deodorant", "Deodorant", l.get(1));
    assertEquals("added Soap", "Soap", l.get(2));
    l.remove("Soap");
    
    assertEquals("check", "Deodorant", l.get(1));
    assertEquals("check", "Shampoo", l.get(0));
  }
  ...
  public void testRemoveMid() {
    ...
    //remove index (start)
    l.remove(0);
    assertEquals("added two items and second was Soap", "Soap", l.get(0));
    
    //remove object (start)
    l.add("Deodorant");
    l.add("Shampoo");
    assertEquals("item 3: Shampoo", "Shampoo", l.get(2));
    assertEquals("item1: Soap", "Soap", l.get(0));
    assertEquals("item 2: Deodorant", "Deodorant", l.get(1));
    l.remove(0);
    assertEquals("item 3: Shampoo", "Shampoo", l.get(1));
    assertEquals("item 2: Deodorant", "Deodorant", l.get(0));

    //remove object (mid)
    l.add("Soap");
    l.remove("Shampoo");
    assertEquals("check", "Soap", l.get(1));
    assertEquals("check", "Deodorant", l.get(0));
  }
